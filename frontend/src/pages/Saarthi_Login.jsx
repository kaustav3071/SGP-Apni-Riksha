...
const Saarthi_Login = () => {
    ...
    const { setSaarthi } = React.useContext(SaarthiDataContext);
        ...
        <div className="h-screen flex flex-col bg-yellow-100 p-7 justify-center items-center" style={{ fontFamily: 'sans-serif' }}>
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md" style={{ height: "550px" }}>
                <div className="flex items-center justify-center mb-4">
                    <img width="40" height="40" src="https://img.icons8.com/color/48/auto-rickshaw.png" alt="auto-rickshaw" className="mr-2" />
                ...
                <form className="space-y-4" onSubmit={submitHandler}>
                    ...
                    <div className="text-center mt-4">
                        <p className="text-gray-600">
                            New Saarthi? <Link to="/saarthi-signup" className="text-blue-600 hover:underline">Register as a Saarthi</Link>
                        </p>
                    </div>
                </form>
                <Link
